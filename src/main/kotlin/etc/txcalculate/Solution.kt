...
class Solution {
    ...
    private fun getTransactionList(arr: Array<String>): Array<Transaction> =
        arr
            .filter {
    ...
    private fun getFirstPriceSum(arr: Array<String>): Int {
        ...
        for ((index: Int, transaction: Transaction) in transactionList.withIndex()) {
    ...
    private fun getPriceSum(
        targetTransactionList: Array<Transaction>,
        startIndex: Int,
        isReversed: Boolean,
        targetCount: Int
    ): Int {
